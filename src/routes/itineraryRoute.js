...
router.post('/v1/itineraries', validateItinerary, itineraryController.createItinerary);
router.get('/v1/itineraries/:id', itineraryController.getItineraryById);
router.put('/v1/itineraries/:id', validateItinerary, itineraryController.updateItinerary);
